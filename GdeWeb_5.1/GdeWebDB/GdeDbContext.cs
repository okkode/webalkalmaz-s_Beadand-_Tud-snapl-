...
namespace GdeWebDB
{
    public class GdeDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder mb)
        {
            ...
            mb.Entity<MonthlySummary>(entity =>
            {
                entity.ToTable("MONTHLYSUMMARY");
            ...
            mb.Entity<AudioNote>(entity =>
            {
                entity.ToTable("AUDIONOTE");
                entity.HasKey(x => x.AUDIONOTEID);
                entity.HasOne(x => x.User)
                      .WithMany(u => u.AudioNotes)
                      .HasForeignKey(x => x.USERID);
            });
